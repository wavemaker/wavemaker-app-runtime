    ...
    .service('Utils', ['$rootScope', '$location', '$window', 'CONSTANTS', 'WIDGET_CONSTANTS', '$sce', 'DialogService', '$timeout', '$http', '$filter', '$q', '$cookies', 'wmToaster', function ($rootScope, $location, $window, CONSTANTS, WIDGET_CONSTANTS, $sce, DialogService, $timeout, $http, $filter, $q, $cookies, wmToaster) {
        ...
        var userAgent = navigator.userAgent,
            ...
            REGEX = {
                ...
                SUPPORTED_FILE_FORMAT: /\.(txt|js|css|html|script|properties|json|java|xml|xsd|xjb|smd|xmi|sql|log|wsdl|vm|ftl|jrxml|yml|yaml|md|less|jsp)$/i,
            ...
            pluginConfig = {
                'BARCODE_SCANNER' : [{'name' : 'phonegap-plugin-barcodescanner', 'spec' : '6.0.8'}],
                'CALENDAR'        : [{'name' : 'cordova-plugin-calendar', 'spec' : '4.6.0'}],
                'CAMERA'          : [{'name' : 'cordova-plugin-camera', 'spec' : '2.4.1'},
                ...
                'INAPPBROWSER'    : [{'name' : 'cordova-plugin-inappbrowser', 'spec' : '2.0.0'}],
                'STATUSBAR'       : [{'name' : 'cordova-plugin-statusbar', 'spec' : '2.4.0'}],
