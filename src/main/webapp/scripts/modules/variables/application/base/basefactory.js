        ...
        result = {
            "properties": {
                ...
                "wm.LoginVariable": {
                    ...
                    "service": {"hide": true, "required": false},
                    "dataSet": {"value": {}},
                    "dataBinding": {"type": "list", "value": [{"target": "j_username", "type": "string"}, {"target": "j_password", "type": "string"}, {"target": "j_rememberme", "type": "boolean"}], "hide": true},
                ...
                "wm.DeviceVariable" : {
                    ...
                    "service": {"type": "list", "options": [], "widgettype": "typeahead", "required": true, "isprimary": true},
                    "operation": {"type": "list", "hide": true, "options": [], "widgettype": "typeahead", "required": true, "isprimary": true},
