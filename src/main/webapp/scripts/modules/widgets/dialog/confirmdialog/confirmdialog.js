                ...
                '<div class="app-dialog modal-dialog app-confirm-dialog" dialogclass init-widget ng-style="{width: dialogWidth}">' +
                    '<div class="modal-content">' +
                        ...
                        '<div class="app-dialog-footer modal-footer">' +
                            '<wm-button class="btn-secondary" name="{{dialogid}}-ok" caption={{canceltext}} on-click="cancelButtonHandler()"></wm-button>' +
                            '<wm-button class="btn-primary" name="{{dialogid}}-cancel" caption={{oktext}} on-click="okButtonHandler()"></wm-button>' +
                        '</div>' +
                    '</div>' +
                '</div>'
            );
