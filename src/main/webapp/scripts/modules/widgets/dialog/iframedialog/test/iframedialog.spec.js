...
describe("IframeDialog", function () {
    ...
    var $compile,
        ...
        widgetConfig,
        element,
        markup = '<wm-iframedialog name="iframedialog1" width="600" animation="shake" iconclass="glyphicon glyphicon-heart" iconwidth="20" iconheight="15" iconmargin="5"></wm-iframedialog>',
        dialogBody;
