        ...
        $templateCache.put("template/widget/datanavigator.html",
            '<nav data-identifier="datanavigator" class="app-datanavigator clearfix" data-ng-show="show" init-widget apply-styles>' +
                '<ul class="pagination pagination-sm" data-ng-if="navcontrols === \'Advanced\'">' +
                    ...
                    '<li class="pagecount disabled"><span class="input-group input-group-sm"><input title="Current Page" type="number" data-ng-disabled="isDisableCurrent" data-ng-model="currentPage" data-ng-keydown="navigatePage(\'index\', $event)" class="form-control" /><span class="input-group-addon" data-ng-hide="isDisableCount"> of {{pageCount}}</span></span></li>' +
