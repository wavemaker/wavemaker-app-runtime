            ...
            result = {
                "properties": {
                    ...
                    'wm.layouts.form': {
                        ...
                        "captionposition": {"type": "list", "options": ["left", "right", "top"], "value": "left", "showindesigner": true, "widget": "radio", "prefix": "position-"},
                    ...
                    'wm.layouts.liveform': {
                        ...
                        "captionposition": {"type": "string", "options": ["left", "right", "top"], "value": "left", "showindesigner": true, "widget": "radio", "prefix": "position-"},
                        "captionwidth": {"type": "string", "widget": "device-config", "value": "xs-12 sm-3 md-3 lg-3", "showindesigner": true, "widthHeader": "Column Width", "deviceHeader": "Device", "deviceSizes": columnWidths},
                        "dataset": {"type": "array, object", "bindable": "in-bound", "widget": "string"},
                        "advancedsettings": {"type": "button", "hidelabel": true, "iconclass": "web-service"},
                        "height": {"type": "string", "pattern": dimensionRegex},
