    ...
    .factory('PropertiesFactory', ['WIDGET_CONSTANTS', 'CONSTANTS', 'Utils', function (WIDGET_CONSTANTS, CONSTANTS, Utils) {
            ...
            result = {
                "properties": {
                    ...
                    "wm.button": {
                        ...
                        "class": {"type": "string", "pattern": classRegex, "widget": "list-picker", "value": "btn-default", "options": ["btn-primary", "btn-info", "btn-warning", "btn-success", "btn-danger", "btn-lg", "btn-sm", "btn-xs", "btn-link", "btn-transparent", "jumbotron"]}
                    },
                    "wm.rating": {
                    ...
                    "wm.buttongroup": {
                        ...
                        "class": {"type": "string", "pattern": classRegex, "widget": "list-picker", "options": ["btn-group-lg", "btn-group-sm", "btn-group-xs", "btn-toolbar", "btn-group-vertical"]}
                    },
                    "wm.switch": {
                        "width": {"type": "string", "pattern": dimensionRegex},
                        "height": {"type": "string", "pattern": dimensionRegex},
                    ...
                    "wm.tree": {
                        ...
                        "class": {"type": "string", "pattern": classRegex, "widget": "list-picker", "options": ["folder", "plus-minus", "circle-plus-minus", "chevron", "menu", "triangle", "expand-collapse"]},
        ...
        if (CONSTANTS.isStudioMode) {
            result.propertyGroups = [
                ...
                {"name": "valuedisplay", "properties": ["datepattern", "timepattern", "ismeridian", "hourstep", "minutestep", "limit"], "parent": "properties"},
                ...
                {"name": "behavior", "properties": ["defaultmode", "navigation", "pollinterval", "radiogroup", "viewgroup", "showweeks", "autofocus", "readonly", "ignoreparentreadonly", "readonlygrid", "scrolldelay", "scrollamount", "direction",
                    ...
                    "searchbuttonlabel", "morebuttoniconclass", "morebuttonlabel", "capturetype", "loadmode", "loaddelay", "selectionlimit", "searchplaceholder", "shortcutkey", "showcaptions", "multiselect", "radioselect", "enablesort", "gridfirstrowselect", "selectfirstitem"], "parent": "properties"},
