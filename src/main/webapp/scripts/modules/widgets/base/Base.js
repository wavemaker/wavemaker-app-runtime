    ...
    .factory('PropertiesFactory', ['WIDGET_CONSTANTS', 'CONSTANTS', 'Utils', function (WIDGET_CONSTANTS, CONSTANTS, Utils) {
            ...
            result = {
                "properties": {
                    ...
                    'wm.layouts.liveform': {
                        ...
                        "captionalign": {"type": "list", "options": ["left", "center", "right"], "value": "left", "show": false},
                        "captionposition": {"type": "list", "options": ["left", "right", "top"], "value": "left", "show": false},
                        "dataset": {"type": "array, object", "bindable": "in-bound", "widget": "string"},
                        "advancedsettings": {"type": "button", "hidelabel": true, "disabled": true},
                        "height": {"type": "string", "pattern": dimensionRegex},
                        "rowdata": {"type": "string"},
                        ...
                        "defaultmode": {"type": "list", "options": ["View", "Edit"], "value": "View", "show": false},
                        "width": {"type": "string", "pattern": dimensionRegex},
                    ...
                    "wm.livelist": {
                        ...
                        "dataset": {"type": "array, object", "bindable": "in-bound", "widget": "string"},
                        "scopedataset": {"type": "string"},
                        "maxselection": {"type": "number", "bindable": "in-bound"},
        ...
        if (CONSTANTS.isStudioMode) {
            result.propertyGroups = [
                ...
                {"properties": ["widget", "caption", "gridcaption", "title", "displayname", "heading", "name", "debugurl", "type", "inputtype", "accept", "filetype", "extensions", "placeholder", "currency",  "hint", "tabindex", "target",  "description", "message", "oktext", "canceltext", "servicevariabletotrack", "valuetype", "alerttype", "iframesrc", "insert", "dropposition"], "parent": "properties"},
                ...
                {"name": "behavior", "properties": ["navigation", "pollinterval", "radiogroup", "viewgroup", "showweeks", "autofocus", "readonly", "messagelayout", "insertmessage", "updatemessage", "deletemessage", "errormessage", "ignoreparentreadonly", "readonlygrid",
                    ...
                    "uploadpath", "contenttype", "destination", "maxfilesize","isdefaulttab", "isdefaultpane", "autocomplete", "nodatamessage", "confirmdelete", "loadingdatamsg", "showpreview", "defaultmode", "tooltips", "showlegend", "legendposition", "legendtype", "captions", "showxaxis", "showyaxis", "xdomain", "ydomain", "showvalues",
                    ...
                    "searchbuttonlabel", "morebuttoniconclass", "morebuttonlabel", "menuposition", "capturetype", "loadmode", "loaddelay", "maxselection", "searchplaceholder", "shortcutkey", "showcaptions"], "parent": "properties"},
                ...
                {"name": "callbackevents", "properties": ["onReady", "onStart", "onComplete", "onBeforeupdate", "onShow", "onHide", "onSuccess", "onError", "onOk", "onSubmit", "onCancel", "onClose", "onOpened", "onExpand", "onCollapse", "onSelect", "onDeselect", "onViewrender",
                    ...
                    "onBeforeSegmentChange", "onSegmentChange", "onSearch", "onBackbtnclick", "onEventdrop", "onEventresize", "onEventclick", "onEventrender", "onSelectionlimitexceed", "onFullscreen" ,"onExitfullscreen"], "parent": "events"},
