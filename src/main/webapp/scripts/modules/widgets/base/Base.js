    ...
    var widgetEventOptions = WM.copy(WIDGET_CONSTANTS.EVENTS_OPTIONS), /*A copy of the variable to preserve the actual value.*/
        ...
        result = {
            ...
            "propertyGroups": [
                ...
                {"name": "datagrid", "properties": ["insertrow", "deleterow", "confirmdelete", "deletemessage", "loadingdatamsg", "updaterow", "shownavigation", "showrecordcount", "multiselect", "radioselect", "enablesort", "gridsearch", "searchlabel", "showrowindex", "gridfirstrowselect"], "parent": "properties"},
