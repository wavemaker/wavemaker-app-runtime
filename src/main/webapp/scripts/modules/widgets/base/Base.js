    ...
    .factory('PropertiesFactory', ['WIDGET_CONSTANTS', 'CONSTANTS', 'Utils', '$rootScope', function (WIDGET_CONSTANTS, CONSTANTS, Utils, $rs) {
        ...
        if (CONSTANTS.isStudioMode) {
            result.propertyGroups = [
                ...
                {"name": "behavior", "properties": ["method", "action", "enctype", "target", "defaultview", "defaultmode", "defaultpaneindex", "pollinterval", "radiogroup", "viewgroup","showdropdownon", "dataentrymode", "showweeks", "showbuttonbar", "autofocus", "readonly", "ignoreparentreadonly", "editmode", "scrolldelay", "scrollamount", "direction",
                ...
                {"name": "callbackevents", "properties": ["onReady", "onStart", "onComplete", "onBeforeupdate", "onBeforeadd", "onAdd", "onBeforeremove", "onRemove", "onShow", "onHide", "onOk", "onBeforesubmit", "onSubmit", "onCancel", "onClose", "onOpened", "onExpand", "onCollapse", "onBeforeselect", "onSelect", "onChipclick", "onChipselect", "onDeselect", "onViewrender", "onBeforerender",
                    ...
                    "onBeforesegmentchange", "onSegmentchange", "onSearch", "onBackbtnclick", "onEventdrop", "onEventresize", "onEventclick", "onEventrender", "onBeforereorder", "onReorder", "onSelectionlimitexceed", "onFullscreen", "onExitfullscreen", "onNext", "onPrev", "onSkip", "onDone", "onBeforedatarender", "onDatarender", "onRender", "onPaginationchange", "onSetrecord", "onBeforenavigate","onBeforeexport", "onBeforefilter"], "parent": "events"},
