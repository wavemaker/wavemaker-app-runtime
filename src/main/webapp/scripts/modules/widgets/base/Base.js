    ...
    .factory('PropertiesFactory', ['WIDGET_CONSTANTS', 'CONSTANTS', 'Utils', '$rootScope', function (WIDGET_CONSTANTS, CONSTANTS, Utils, $rs) {
            ...
            result = {
                "properties": {
                    ...
                    "wm.base.datetime": {
                        ...
                        "dataentrymode": {"type": "select-by-object", "options": [{"label": "Default (Date/DateTime/Time Picker & Input)", "value":"default"}, {"label": "Date/DateTime/Time Picker Only", "value":"picker"}], "value": "default"},
                        /* ---- styles ----*/
                    ...
                    "wm.list": {
                        ...
                        "onBeforedatarender": {"type": "event", "options": widgetEventOptions, "widget": "eventlist"},
                        "onRender": {"type": "event", "options": widgetEventOptions, "widget": "eventlist"},
        ...
        if (CONSTANTS.isStudioMode) {
            result.propertyGroups = [
                ...
                {"name": "behavior", "properties": ["method", "action", "enctype", "target", "defaultview", "templateview", "defaultmode", "defaultpaneindex", "pollinterval", "radiogroup", "viewgroup","showdropdownon", "dataentrymode", "showweeks", "showbuttonbar", "autofocus", "readonly", "ignoreparentreadonly", "editmode", "scrolldelay", "scrollamount", "direction",
                ...
                {"name": "callbackevents", "properties": ["onReady", "onStart", "onComplete", "onBeforeupdate", "onBeforeadd", "onAdd", "onBeforeremove", "onRemove", "onShow", "onHide", "onOk", "onBeforesubmit", "onSubmit", "onCancel", "onClose", "onOpened", "onExpand", "onCollapse", "onRowclick", "onRowselect", "onRowdeselect", "onBeforeselect", "onSelect", "onChipclick", "onChipselect", "onDeselect", "onViewrender", "onBeforerender",
                    ...
                    "onBeforesegmentchange", "onSegmentchange", "onSearch", "onBackbtnclick", "onEventdrop", "onEventresize", "onEventclick", "onEventrender", "onBeforereorder", "onReorder", "onSelectionlimitexceed", "onFullscreen", "onExitfullscreen", "onNext", "onPrev", "onSkip", "onDone", "onBeforedatarender", "onDatarender", "onRender", "onPaginationchange", "onPulltorefresh", "onSetrecord", "onBeforenavigate","onBeforeexport", "onBeforefilter"], "parent": "events"},
