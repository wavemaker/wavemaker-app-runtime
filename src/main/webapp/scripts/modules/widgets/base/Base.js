    ...
    .factory('PropertiesFactory', ['WIDGET_CONSTANTS', 'CONSTANTS', 'Utils', '$rootScope', function (WIDGET_CONSTANTS, CONSTANTS, Utils, $rs) {
        ...
        if (CONSTANTS.isStudioMode) {
            result.propertyGroups = [
                ...
                {"name": "validation", "properties": ["required", "validationmessage", "regexp", "mindate", "maxdate", "excludedays", "excludedates", "novalidate", "validationtype", "maxchars"], "parent": "properties"},
