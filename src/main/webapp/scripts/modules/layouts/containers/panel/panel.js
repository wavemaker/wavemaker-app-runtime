                    ...
                    '<div class="panel-heading" data-ng-class="helpClass">' +
                        '<h3 class="panel-title">' +
                            ...
                            '<div class="panel-actions">' +
                                ...
                                '<wm-menu type="anchor" class="panel-action" scopedataset="actions" iconname="more-vert" data-ng-if="actions" title="{{::$root.appLocale.LABEL_ACTIONS}}" on-select="onActionsclick({$item:$item})" datafield="{{datafield}}" itemlabel="{{binditemlabel || itemlabel || displayfield}}" menuposition="down,left" itemicon="{{binditemicon || itemicon}}" itemlink="{{binditemlink || itemlink}}" itemchildren="{{binditemchildren || itemchildren}}"></wm-menu>' +
