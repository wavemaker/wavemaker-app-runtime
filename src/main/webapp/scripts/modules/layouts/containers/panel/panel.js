                    ...
                    '<div class="panel-heading" data-ng-class="helpClass">' +
                        '<h3 class="panel-title">' +
                            ...
                            '<div class="panel-actions">' +
                                ...
                                '<button type="button" class="app-icon wi panel-action wi-remove" title="{{::$root.appLocale.LABEL_CLOSE}}" data-ng-if="closable" data-ng-click="closePanel();onClose({$event: $event, $scope: this})"></button>' +
                            '</div>' +
                        '</h3>' +
                    '</div>' +
