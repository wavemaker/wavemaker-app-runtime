            ...
            'mobile-runtime-files': { // mobile changes
                ...
                files: {
                    '<%= config.mobile %>/scripts/mobileruntimeloader.js': [
                        ...
                        '<%= config.scripts %>/modules/mobile/widgets/deviceNative/camera/camera.js',
                        '<%= config.scripts %>/modules/mobile/widgets/deviceNative/barcodeScanner/barcodeScanner.js',
                        '<%= config.scripts %>/modules/mobile/widgets/deviceNative/fileBrowser/fileBrowser.js',
