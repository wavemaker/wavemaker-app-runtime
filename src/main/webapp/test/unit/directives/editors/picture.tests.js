...
describe("\nUnit: Testing Editor Directives: Picture", function () {
    'use strict';
    ...
    beforeEach(WM.mock.inject(function ($compile, $rootScope) {
        element = WM.element('<wm-picture></wm-picture>');
    ...
    it("should default width is 100", function () {
        expect(element.scope().width).toBe(100);
    });


    it("should default height is 100", function () {
        expect(element.scope().height).toBe(100);
    });
    ...
    it("should element source change to picture.png", function () {
        element.scope().src = 'picture.png';
        element.scope().$apply();
        expect(element.find('img').attr('src')).toBe('picture.png');
    });

    it("should element link change to http://www.wavemaker.com/ ", function () {
        element.scope().link = 'http://www.wavemaker.com/';
        element.scope().$apply();
        expect(element.find('a').attr('href')).toBe('http://www.wavemaker.com/');
    });
