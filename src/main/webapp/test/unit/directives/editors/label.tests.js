...
describe("\nUnit: Testing Editor Directives: Label", function () {
    'use strict';
    ...
    beforeEach(WM.mock.inject(function ($compile, $rootScope) {
        element = WM.element('<wm-label></wm-label>');
    ...
    it("should default width property is to be 180", function () {
        expect(element.scope().width).toBe(180);
    });
