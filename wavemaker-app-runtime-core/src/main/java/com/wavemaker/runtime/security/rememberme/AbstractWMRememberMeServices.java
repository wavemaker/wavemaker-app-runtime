...
/**
 * Similar to {@link AbstractRememberMeServices} except that this class does not need {@link UserDetailsService}
 */
public abstract class AbstractWMRememberMeServices implements RememberMeServices, InitializingBean, LogoutHandler {
    //~ Static fields/initializers =====================================================================================

    static final String SPRING_SECURITY_REMEMBER_ME_COOKIE_KEY = "SPRING_SECURITY_REMEMBER_ME_COOKIE";
    static final String DEFAULT_PARAMETER = "_spring_security_remember_me";
    static final int TWO_WEEKS_S = 1209600;
