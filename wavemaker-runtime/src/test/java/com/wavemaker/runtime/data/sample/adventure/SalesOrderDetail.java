...
public class SalesOrderDetail implements java.io.Serializable {
    ...
    public SalesOrderDetail(SalesOrderDetailId id, SalesOrderHeader salesOrderHeader, Product product, short orderQty, BigDecimal unitPrice,
        BigDecimal unitPriceDiscount, BigDecimal lineTotal, String rowguid, Date modifiedDate) {
        this.id = id;
