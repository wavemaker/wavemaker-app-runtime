...
/**
 * Vstafac2Id generated by hbm2java
 */
@SuppressWarnings({ "serial" })
public class Vstafac2Id implements java.io.Serializable {
    ...
    public Vstafac2Id(String projno, short actno, String actdesc, String empno, String firstnme, String lastname, String type) {
        this.projno = projno;
        this.actno = actno;
    ...
    public Vstafac2Id(String projno, short actno, String actdesc, String empno, String firstnme, Character midinit, String lastname,
        BigDecimal emptime, Date stdate, Date endate, String type) {
        this.projno = projno;
        this.actno = actno;
        this.actdesc = actdesc;
        this.empno = empno;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Vstafac2Id)) {
            return false;
        }
        Vstafac2Id castOther = (Vstafac2Id) other;
        ...
        return (this.getProjno() == castOther.getProjno() || this.getProjno() != null && castOther.getProjno() != null
            ...
            && (this.getStdate() == castOther.getStdate() || this.getStdate() != null && castOther.getStdate() != null
                && this.getStdate().equals(castOther.getStdate()))
            && (this.getEndate() == castOther.getEndate() || this.getEndate() != null && castOther.getEndate() != null
                && this.getEndate().equals(castOther.getEndate()))
