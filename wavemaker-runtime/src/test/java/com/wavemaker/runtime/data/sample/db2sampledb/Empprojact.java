...
/**
 * Empprojact generated by hbm2java
 */
@SuppressWarnings({ "serial" })
public class Empprojact implements java.io.Serializable {

    private EmpprojactId id;
    ...
    public Empprojact(EmpprojactId id, Projact projact) {
        this.id = id;
        this.projact = projact;
    }

    public EmpprojactId getId() {
        return this.id;
    }

    public void setId(EmpprojactId id) {
        this.id = id;
    }
