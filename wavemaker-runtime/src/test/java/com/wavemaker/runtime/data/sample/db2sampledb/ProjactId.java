...
/**
 * ProjactId generated by hbm2java
 */
@SuppressWarnings({ "serial" })
public class ProjactId implements java.io.Serializable {
    ...
    public ProjactId(String projno, short actno, Date acstdate) {
        this.projno = projno;
        this.actno = actno;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ProjactId)) {
            return false;
        }
        ProjactId castOther = (ProjactId) other;
