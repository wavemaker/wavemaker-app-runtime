...
public class Project implements java.io.Serializable {
    ...
    public Project(String projno, Project project, Employee employee, Department department, String projname, BigDecimal prstaff, Date prstdate,
        Date prendate, Set projects, Set projacts) {
        this.projno = projno;
