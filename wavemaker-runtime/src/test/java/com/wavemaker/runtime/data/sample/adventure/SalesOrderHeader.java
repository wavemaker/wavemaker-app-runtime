...
public class SalesOrderHeader implements java.io.Serializable {
    ...
    public SalesOrderHeader(int salesOrderId, Customer customer, byte revisionNumber, Date orderDate, Date dueDate, byte status,
        boolean onlineOrderFlag, String salesOrderNumber, String shipMethod, BigDecimal subTotal, BigDecimal taxAmt, BigDecimal freight,
        BigDecimal totalDue, String rowguid, Date modifiedDate) {
    ...
    public SalesOrderHeader(int salesOrderId, Address addressByShipToAddressId, Address addressByBillToAddressId, Customer customer,
        byte revisionNumber, Date orderDate, Date dueDate, Date shipDate, byte status, boolean onlineOrderFlag, String salesOrderNumber,
        String purchaseOrderNumber, String accountNumber, String shipMethod, String creditCardApprovalCode, BigDecimal subTotal, BigDecimal taxAmt,
        BigDecimal freight, BigDecimal totalDue, Clob comment, String rowguid, Date modifiedDate, Set salesOrderDetails) {
        this.salesOrderId = salesOrderId;
