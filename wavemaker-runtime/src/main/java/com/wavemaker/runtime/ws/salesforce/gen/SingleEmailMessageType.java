...
@XmlType(name = "SingleEmailMessage", namespace = "urn:partner.soap.sforce.com", propOrder = { "bccAddresses", "ccAddresses", "charset",
    "documentAttachments", "htmlBody", "inReplyTo", "fileAttachments", "orgWideEmailAddressId", "plainTextBody", "references", "targetObjectId",
    "templateId", "toAddresses", "whatId" })
public class SingleEmailMessageType extends EmailType {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the documentAttachments property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
    ...
    public List<String> getDocumentAttachments() {
        if (this.documentAttachments == null) {
            this.documentAttachments = new ArrayList<String>();
        }
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link EmailFileAttachmentType }
     * 
     * 
     */
    public List<EmailFileAttachmentType> getFileAttachments() {
        if (this.fileAttachments == null) {
            this.fileAttachments = new ArrayList<EmailFileAttachmentType>();
        }
     ...
     * 
     * @param bccAddresses allowed object is {@link String }
     * 
     */
     ...
     * 
     * @param ccAddresses allowed object is {@link String }
     * 
     */
     ...
     * 
     * @param documentAttachments allowed object is {@link String }
     * 
     */
     ...
     * 
     * @param fileAttachments allowed object is {@link EmailFileAttachmentType }
     * 
     */
     ...
     * 
     * @param toAddresses allowed object is {@link String }
     * 
     */
