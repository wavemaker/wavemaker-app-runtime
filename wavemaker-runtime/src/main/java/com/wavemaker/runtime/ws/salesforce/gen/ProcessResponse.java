...
public class ProcessResponse {
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link ProcessResultType }
     * 
     * 
     */
    public List<ProcessResultType> getResults() {
        if (this.results == null) {
            this.results = new ArrayList<ProcessResultType>();
        }
        return this.results;
    }
     ...
     * 
     * @param results allowed object is {@link ProcessResultType }
     * 
     */
