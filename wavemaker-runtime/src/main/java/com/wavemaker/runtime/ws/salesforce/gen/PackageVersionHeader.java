...
@XmlType(name = "", propOrder = { "packageVersions" })
...
public class PackageVersionHeader {
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link PackageVersionType }
     * 
     * 
     */
    public List<PackageVersionType> getPackageVersions() {
        if (this.packageVersions == null) {
            this.packageVersions = new ArrayList<PackageVersionType>();
        }
     ...
     * 
     * @param packageVersions allowed object is {@link PackageVersionType }
     * 
     */
