...
public class DescribeDataCategoryGroupStructuresResponse {
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link DescribeDataCategoryGroupStructureResultType }
     * 
     * 
     */
    public List<DescribeDataCategoryGroupStructureResultType> getResults() {
        if (this.results == null) {
            this.results = new ArrayList<DescribeDataCategoryGroupStructureResultType>();
        }
        return this.results;
    }
     ...
     * 
     * @param results allowed object is {@link DescribeDataCategoryGroupStructureResultType }
     * 
     */
