...
@XmlType(name = "", propOrder = { "requests" })
...
public class Merge {
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link MergeRequestType }
     * 
     * 
     */
    public List<MergeRequestType> getRequests() {
        if (this.requests == null) {
            this.requests = new ArrayList<MergeRequestType>();
        }
     ...
     * 
     * @param requests allowed object is {@link MergeRequestType }
     * 
     */
