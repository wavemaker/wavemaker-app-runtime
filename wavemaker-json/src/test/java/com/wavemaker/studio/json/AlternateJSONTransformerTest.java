...
import com.wavemaker.studio.json.AlternateJSONTransformerTest.IsNested.IsNestedDeeper;
import com.wavemaker.studio.json.AlternateJSONTransformerTest.IsNested.IsNestedDeeper.IsNestedEvenDeeper;
import com.wavemaker.studio.json.AlternateJSONTransformerTest.IsNested.IsNestedDeeper.IsNestedEvenDeeper.IsNestedDeepest;
...
import com.wavemaker.studio.json.JSONSerializationTest.Product;
 ...
 * @author Matt Small
 */
public class AlternateJSONTransformerTest extends WMTestCase {
    ...
    public void testObjectWithClass() throws Exception {
        ...
        String js = "{\"klass\":\"com.wavemaker.studio.json.JSONMarshallerTest\"}";
        ...
        assertEquals(JSONMarshallerTest.class, owc.getKlass());
    }
