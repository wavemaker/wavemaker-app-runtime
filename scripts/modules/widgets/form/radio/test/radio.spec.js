...
describe("Radio", function () {
    ...
    beforeEach(function () {
        ...
        inject(function (_$compile_, _$rootScope_) {
            ...
            element = $compile('<wm-radio></wm-radio>')($rootScope);
            $rootScope.$digest();
            scope = $rootScope;
        });
    });
    ...
    describe("styles", function () {
        ...
        it("should add inputClass to radio", function () {
    ...
    describe("properties", function () {
        ...
        it("should change the required property of the radiobutton on toggling required property", function () {
        ...
        it("should change the readonly property of the radiobutton on toggling readonly property", function () {
            element.isolateScope().readonly = true;
            element.isolateScope().$apply();
            expect(element.attr('readonly')).toBeTruthy();
        });
        it("should change helptext for radiobutton to helpText when put in property panel", function () {
            element.isolateScope().hint = "helpText";
            element.isolateScope().$apply();
            expect(element.attr('title')).toMatch(/helpText/i);
        });
        it("should change caption name to textWidget when put in property panel", function () {
            element.isolateScope().radiogroup = "radiobutton";
            element.isolateScope().$apply();
            expect(element.attr('name')).toMatch(/radiobutton/i);
        });
    });
    ...
    describe("behavior", function () {
        ...
        /* it("should trigger assigned change event", function () {
         var testVariable = 1;
         element.isolateScope().onChange = function () {
         testVariable = 2;
         };
         element.change();
