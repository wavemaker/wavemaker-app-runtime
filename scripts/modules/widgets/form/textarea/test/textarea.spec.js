...
describe("Textarea", function () {
    ...
    beforeEach(function () {
        ...
        inject(function (_$compile_, _$rootScope_) {
            ...
            element = $compile('<wm-textarea></wm-textarea>')($rootScope);
            $rootScope.$digest();
            scope = $rootScope;
        });
    });
    ...
    describe("styles", function () {
        ...
        it("should add textareaClass to textbox", function () {
            element.isolateScope().class = 'textareaClass';
            element.isolateScope().$apply();
            expect(element.hasClass('textareaClass')).toBeTruthy();
        });
    });
    ...
    describe("properties", function () {
        ...
        it("should change helptext for textarea to helpText when put in property panel", function () {
