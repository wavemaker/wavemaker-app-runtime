        ...
        result = {
            "properties": {
                ...
                "wm.alertdialog": {
                    ...
                    "iconclass": {"type": "string", "widget": "selecticon", "bindable": "in-out-bound", "value": "glyphicon glyphicon-warning-sign"},
                ...
                "wm.confirmdialog": {
                    ...
                    "oktext": {"type": "string", "value": "OK", "bindable": "in-bound"},
                    "iconclass": {"type": "string", "widget": "selecticon", "bindable": "in-out-bound", "value": "glyphicon glyphicon-ok"},
...
//                    "verticalalign": {"type": "list", "options": ["top", "middle", "bottom"]},
                ...
                'wm.layouts.panel': {
                    ...
                    "description": {"type": "string", "bindable": "in-bound"},
                    "iconclass": {"type": "string", "widget": "selecticon", "bindable": "in-out-bound"},
                ...
                'wm.grid': {
                    ...
                    /* Styles */
                    "gridclass": {"type": "string", "value": "table-bordered table-striped table-hover"},
                    "class": {"type": "string", "show": false}
                },
                'wm.livegrid': {
                ...
                "wm.chart": {
                    ...
                    "tooltipcolumns": {"type": "list", "widget": "multiselect"},
                    "show": {"type": "boolean", "value": true, "bindable": "in-out-bound"},
                    ...
                    "offsettop": {"type": "number", "value": 25},
                    "offsetbottom": {"type": "number", "value": 55},
                    "offsetleft": {"type": "number", "value": 75},
                    "offsetright": {"type": "number", "value": 25},
                    ...
                    "showxdistance": {"type": "boolean", "value": true},
                    "showydistance": {"type": "boolean", "value": true},
                    ...
                    "theme": {"type": "list", "options": ["Terrestrial", "Annabelle", "Azure", "Retro", "Mellow", "Orient", "GrayScale", "Flyer"], "value": "Terrestrial"},
                    ...
                    "color": {"type": "string", "hidelabel": true, "widget": "color"},
                    "fontweight": {"type": "string", "options": ["bold"], "hidelabel": true, "widget": "icons_checkbox"},
                    "fontsize": {"type": "number", "hidelabel": true, "hint": "Font size", "value": 12},
                    "fontunit": {"type": "string", "options": ["em", "px"], "value": "px", "hidelabel": true, "widget": "icons_radio"},
                    "textdecoration": {"type": "string", "options": ["underline"], "hidelabel": true, "widget": "icons_checkbox"},
                    "fontstyle": {"type": "string", "options": ["italic"], "hidelabel": true, "widget": "icons_checkbox"},
                    "fontfamily": {"type": "string", "hidelabel": true, "hint": "Arial, Geneva"},
            ...
            "propertyGroups": [
                ...
                {"properties": ["caption", "badgevalue", "gridcaption", "title", "name", "type", "striped", "accept", "heading", "placeholder", "currency",  "hint", "tabindex", "target",  "description", "message", "oktext", "canceltext", "servicevariabletotrack", "valuetype", "alerttype", "iframesrc", "insert", "dropposition"], "parent": "properties"},
                {"name": "layout", "properties": ["width", "height", "treeicons", "pictureaspect", "shape", "layoutkind", "layout", "navtype", "stacked", "justified", "formlayout", "itemsperrow", "showheader", "offset", "addrow", "addcolumn"], "parent": "properties"},
                ...
                {"name": "values", "properties": [ "scopedatavalue", "datavalue", "minvalue", "maxvalue", "displayformat", "updateon", "updatedelay", "formdata", "selectedvalue", "selectedvalues", "discretevalues", "integervalues", "minimum", "maximum", "step", "defaultvalue", "defaultcolor", "hyperlink", "checkedvalue", "uncheckedvalue"], "parent": "properties"},
                {"name": "valuedisplay", "properties": ["places", "datepattern", "ismeridian", "hourstep", "minutestep", "limit"], "parent": "properties"},
                {"name": "dataset", "properties": ["operation", "scopedataset", "dataset", "options", "formfield", "editcolumn", "editfields", "editfilters", "method", "action", "enctype", "searchkey", "displaylabel", "imgsrc", "displayimagesrc", "usekeys", "datafield", "itemicon", "itemlabel", "itemlink", "itemchildren", "displayfield", "displayexpression",  "groupby", "aggregation", "aggregationcolumn", "orderby", "orderbycolumn", "nodelabel", "nodeicon", "nodechildren"], "parent": "properties"},
                ...
                {"name": "behavior", "properties": ["pollinterval", "radiogroup", "viewgroup", "startchecked", "autofocus", "readonly", "insertmessage", "updatemessage", "ignoreparentreadonly", "readonlygrid",
                    "multiple", "tooltipcolumns", "show", "controls", "disabled", "pagesize", "dynamicslider", "selectionclick", "closeothers", "collapsible",
                    "lock", "freeze", "autoscroll", "closable", "actions", "expanded",  "destroyable", "showDirtyFlag", "link",
                    "uploadpath", "contenttype", "destination", "isdefaulttab", "isdefaultpane", "autocomplete", "nodatamessage", "showpreview", "updatemode", "errormessage", "tooltips", "showlegend", "showvalues", "showlabels", "showcontrols", "useinteractiveguideline", "staggerlabels", "reducexticks", "barspacing", "labeltype", "autoplay", "loop", "muted", "donutratio", "showlabelsoutside", "legendposition", "showxdistance", "showydistance", "xpadding", "ypadding"], "parent": "properties"},
                ...
                {"name": "popup", "properties": ["popupcontent", "ispopuptext", "popupplacement", "popupidentifier", "popuparrow", "popupautoclose"], "parent": "properties"},
                {"name": "operations", "properties": ["submitbutton", "resetbutton"], "parent": "properties"},
                {"properties": [ "class", "menuclass", "listclass", "itemclass", "gridclass", "theme"], "parent": "styles"},
