...
import com.wavemaker.studio.core.io.store.StoredFolder;
...
public class MongoFolder extends StoredFolder {
    ...
    private final MongoResourceStore.MongoFolderStore store;
     ...
     */
    MongoFolder(MongoResourceStore.MongoFolderStore store) {
        this.store = store;
    }
    ...
    public MongoFolder(DB db, String bucket) {
        ...
        this.store = new MongoResourceStore.MongoFolderStore(fs, new JailedResourcePath());
    }
