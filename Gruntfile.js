            ...
            'runtime-files': {
                ...
                files: {
                    '<%= config.dest %>/application/runtimeloader.js': [
                        ...
                        '<%= config.scripts %>/modules/prefabs/config.js',
                        ...
                        '<%= config.scripts %>/modules/layouts/config.js',
                        '<%= config.scripts %>/modules/layouts/containers/config.js',
                        ...
                        '<%= config.scripts %>/modules/widgets/config.js',
                        '<%= config.app %>/scripts/modules/studio/widgets-util.js',
                        ...
                        '<%= config.scripts %>/modules/plugins/database/application/services/datamodelDesignManager.js',
